  ...
  <div class="page-container unselectable">
    <md-app md-waterfall md-mode="fixed-last">
      <md-app-toolbar class="md-large md-dense md-primary tool-bar">
        <div class="md-toolbar-row">
          <div class="md-toolbar-section-start">
            ...
            <span class="md-title unselectable car">Super Hero Demo</span>
          </div>
          ...
          <md-dialog class="wallet" :md-click-outside-to-close=false :md-active.sync="isWallet">
            <md-toolbar class="md-accent md-dense">
              <h3 class="md-title" style="flex: 1">Super Hero Wallet</h3>
            ...
            <div v-if="isCreate">
              <div class="wallet-content">
                <div class="md-subheading">
                  Create a new Super Hero Account
                </div>
                <br>
                <br>
                <br>
            ...
            <div v-if="isRestore">
              <div class="wallet-content">
                <div class="md-subheading">
                  Restore your Super Hero Account with Seed
                </div>
                <br>
            ...
            <div v-if="isCheck">
              <div class="wallet-content">
                <div class="md-subheading">
                  Super Hero Account Information
                </div>
                <br>
                ...
                <div class="md-layout-item md-size-90">
                  <md-field>
                    <label>Account Balance in Rinkeby</label>
      ...
      <md-app-drawer :md-active.sync="menuVisible">
        ...
        <div class="md-subheading title">Super Hero</div>
        <md-list>
